...
def get_fitline(img, lines):  # 대표선 구하기
...
# 앞에서 그려진 직선 성분들을 Angle(각도)로 변환하여 slope_degree 리스트 생ㅅ헝
...
cv2.line(line_img, (left_fit_line[0], left_fit_line[1]), (left_fit_line[2], left_fit_line[3]), (255, 0, 0), 2)
cv2.line(line_img, (right_fit_line[0], right_fit_line[1]), (right_fit_line[2], right_fit_line[3]), (255, 0, 0), 2)
